...
from sklearn.ensemble import VotingRegressor as model
from sklearn.tree import DecisionTreeRegressor as em
l = [("dt", em("mse")),
     ("ard", sklearn.linear_model.ARDRegression(n_iter=1000)),
     ("svr", sklearn.svm.SVR(kernel="poly", degree=4, coef0=4)),
     ]
trained, trained_ex, valid = WindtexModel.grow(model=model(estimators=l))
